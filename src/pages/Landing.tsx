    ...
    return (
        <div>
            <section className="h-full flex flex-col md:flex-row items-center" style={{ backgroundImage: `url('/svg/dark-bg.svg')`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                ...
                <div className="ml-0 md:ml-20 w-full md:w-2/3 text-center md:text-left text-4xl md:text-5xl text-gray-300 p-4">
            ...
            <section className="h-full bg-gray-100 justify-center py-8 text-gray-700 flex flex-col items-center">
                <div className='font-bold w-full text-center text-4xl md:text-5xl mb-4'>
            ...
            <section className="py-10 h-full flex items-center" style={{ backgroundImage: `url('/svg/tech-bg.svg')`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
