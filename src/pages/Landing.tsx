            ...
            <section className="h-full flex flex-col md:flex-row items-center" style={{ backgroundImage: `url('/png/dark-bg.png')`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundColor: '#0b1536' }}>
                ...
                <div className="ml-0 md:ml-20 w-full md:w-2/3 text-center md:text-left text-3xl md:text-5xl text-gray-300 p-4">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden shadow-lg my-4 p-2">
                        ...
                        <button
                            type="submit"
                            className="md:w-2/5 w-2/3 text-gray-300 text-lg leading-tight bg-gradient-to-r from-blue-700 to-green-600 hover:from-blue-500 hover:to-green-500 rounded-full mt-2 px-4 py-2 flex items-center justify-center overflow-hidden flex-wrap"
                            style={{
                                boxShadow: '0 0 5px rgba(81, 203, 238, 0.5)',
                            }}
                        >
            ...
            <section className="p-10 h-full flex items-center" style={{ backgroundImage: `url('/png/dark-bg.png')`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundColor: '#0b1536' }}>
                <div className="w-3/4 text-3xl text-gray-100">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden my-4 p-2">
                        ...
                        <button
                            type="submit"
                            className="md:w-1/3 w-2/3 text-gray-300 text-lg leading-tight bg-gradient-to-r from-blue-700 to-green-600 hover:from-blue-500 hover:to-green-500 rounded-full mt-2 px-4 py-2 flex items-center justify-center overflow-hidden flex-wrap"
                            style={{
                                boxShadow: '0 0 5px rgba(81, 203, 238, 0.5)',
                            }}
                        >
