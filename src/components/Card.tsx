  ...
  <div className="max-w-sm rounded overflow-hidden shadow-lg mt-4 bg-white dark:bg-gray-800">
    ...
    <div className="px-6 py-4">
      ...
      {linkUrl && (
        <Link
          to={linkUrl}
          className="inline-block mt-4 px-4 py-2 text-sm font-medium text-gray-300 bg-blue-500 rounded-md shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-blue-600 dark:hover:bg-blue-700"
        >
          Try now!
        </Link>
      )}
