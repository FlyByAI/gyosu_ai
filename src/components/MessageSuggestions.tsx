...
const MessageSuggestion: React.FC<MessageSuggestionProps> = ({ onClick }) => {
    const suggestions = ["I'm new to using GyosuChat, can you help guide me through the process?", "Please create a homework for learning inverse functions for calc 1. Please provide an example with steps to help the students recall about what we did in class so they can complete the problems successfully at home. Add key terms at the top like 'one to one' that are helpful for understanding the work.", "What subjects do you have? What are your capabilities?", "Can you create me a quiz on Polynomials from Elementary Algebra?"];
