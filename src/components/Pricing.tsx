...
const Pricing = () => {
    ...
    return (
        <div className='text-gray-300 text-l'>
            <section id="pricing">
                <div className='flex flex-col md:flex-row justify-between'>
                    ...
                    <div className="tier w-full md:w-1/3 p-6 rounded-md shadow-lg bg-gray-800 border border-gray-700 my-4 md:mx-4">
                        ...
                        {/* {!session && <SubscribeFreeButton className="btn w-1/3 text-gray-300 font-bold min-w-fit rounded-md border border-blue-500 shadow-sm p-4 bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 cursor-pointer" />}
                        {session && <SubscribeFreeButton className="w-1/3 text-gray-300 font-bold min-w-fit rounded-md shadow-sm p-4 bg-gray-600" />} */}
                        <br></br>
                        <div className='mb-2' />
                        <hr></hr>
                    ...
                    <div className="tier w-full md:w-1/3 p-6 rounded-md shadow-lg bg-gray-800 border border-gray-700 my-4 md:mx-4">
                        ...
                        <br></br>
                        <SubscribePaidButton className="btn w-1/3 text-gray-300 font-bold min-w-fit rounded-md border border-blue-500 shadow-sm p-4 bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 cursor-pointer" />
                    </div>
                    ...
                    <div className="tier w-full md:w-1/3 p-6 rounded-md shadow-lg bg-gray-800 border border-gray-700 my-4 md:mx-4">
                        ...
                        {/* <SubscribePremiumButton className="btn w-1/3 text-gray-300 font-bold min-w-fit rounded-md border border-blue-500 shadow-sm py-4 bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 cursor-pointer" /> */}
                        <hr></hr>
                        {/* <p className='my-4 text-left'>Plan includes:</p> */}
                        <ul className='list-decimal-none list-inside text-left space-y-4 mt-4 flex flex-col'>
