...
const ShareLinkModalContent = ({ link }: { link: string }) => {
    ...
    return (
        <div>
            ...
            <button onClick={handleCopy} className="mt-2 px-4 py-2 rounded bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 inline-flex items-center">
                <CopyIcon />
