...
const AIChatSmall: React.FC<ResponseBoxProps> = ({ className, problemIndex, markdown, updateProblem, problemData }) => {
    ...
    return (
        <form ref={formRef} onSubmit={handleSubmit}>
            ...
            {updateProblem && <ChangeProblemModalV2 error={error} problemIndex={problemIndex} updateProblem={updateProblem} onClose={handleCloseModal} isOpen={isModalOpen} setNewProblem={setNewProblem} markdown={markdown} newProblem={newProblem} />}
        </form>
    )
};
