...
const DocumentExport: React.FC<DocumentExportProps> = ({ response, divPrintId, saved, setSaved, formData, documentId, setDocumentId, setResponse }) => {
    ...
    return (<>
        ...
        {response && <MathMarkdown markdown={response} />}
        <div className="flex flex-row mr-2 relative items-end dark:text-gray-300 justify-between mb-4">
            ...
            <div className="flex flex-row">
                <div className="group mr-4 relative">
                    <SaveMarkdownDocument markdown={response} saved={saved} setSaved={setSaved} formData={formData} documentId={documentId} setDocumentId={setDocumentId} />
                </div>
