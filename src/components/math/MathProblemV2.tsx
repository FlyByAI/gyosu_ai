...
import ResponseBoxV2 from './ResponseBoxV2';
...
import RerollResultV2 from './RerollResultV2';
import FixLatexV2 from './FixLatexV2';
                    ...
                    <div className="flex flex-grow flex-col w-1/6 p-4 space-y-4 justify-center items-center">
                        ...
                        <div className="flex flex-row justify-center items-center">
                            ...
                            <div className="group relative dark:text-yellow-300">
                                <FixLatexV2 setChat={setChat} problem={problem.toString()} problemIndex={index} updateProblem={updateProblem} problemData={problemData} />
                        ...
                        <div className="flex flex-row justify-center items-center">
                            <div className="mr-2 group relative dark:text-gray-300">
                                <RerollResultV2 setChat={setChat} problem={problem.toString()} problemIndex={index} updateProblem={updateProblem} problemData={problemData} />
