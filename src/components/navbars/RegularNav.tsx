...
const RegularNavbar: React.FC = () => {
    ...
    return (
        <header className="px-6 sm:pt-0 py-4 bg-blue-900 text-gray-300 dark:bg-gray-900 dark:text-gray-200">
            {/* mobile */}
            ...
            {/* <nav className="grid grid-cols-2 gap-2 lg:flex lg:space-x-3 pt-4">
                <Link to="/math-app/chat" className="relative text-lg text-gray-300 hover:underline dark:text-gray-200 lg:justify-self-end block sm:hidden">
                    GyosuChat
                ...
                <Link to="/math-app" className="text-lg text-gray-300 hover:underline dark:text-gray-200 lg:justify-self-end block sm:hidden">
                    Problem Search
                </Link>
                <Link to="/math-app/documents" className="text-lg text-gray-300 hover:underline dark:text-gray-200 lg:justify-self-end block sm:hidden">
                    My Documents
                </Link>
                <Link to="/faq" className="text-lg text-gray-300 hover:underline dark:text-gray-200 lg:justify-self-end block sm:hidden">
                    How To
                </Link>
                <Link to="/subscribe" className="text-lg text-gray-300 hover:underline dark:text-gray-200 lg:justify-self-end block sm:hidden">
                    Pricing
                </Link>
            </nav> */}
