    ...
    <>
      ...
      <header className="navbar bg-blue-900 text-white fixed top-0 left-0 z-20 w-full">
        ...
        <div className="navbar-end md:hidden">
          <button onClick={navigateToNewChat} className="btn bg-gradient-to-b from-blue-700 to-blue-600 hover:from-blue-800 hover:to-blue-600">
        ...
        <div className="navbar-end flex items-center flex-grow hidden md:flex">
