...
const ChatNavbar: React.FC = () => {
    ...
    return (
        <>
            ...
            <header className="z-20 fixed top-0 left-0 w-full bg-blue-900 text-gray-300 dark:bg-gray-900 dark:text-gray-200">
                {/* mobile */}
                <div className="flex justify-between items-center py-2 px-6 md:hidden">
                    ...
                    <Link to="/" className="text-xl font-semibold text-gray-300 font-mono">Gyosu.ai</Link>

                    {/* New Chat Button */}
                    <button onClick={navigateToNewChat} className="btn-gradient-blue-green font-bold py-2 px-4 rounded flex flex-row">
                        <div className='mr-2'>
                            New
                        </div>
                        <NewChatIcon />
                ...
                <div className="hidden md:flex justify-between items-center py-2">
                    ...
                    <button onClick={navigateToNewChat} className="btn-blue font-bold py-2 px-4 rounded ml-2 flex-row flex">
